...
| `06_Martins_Sturdza_Alonso_2001_Complex_Step.pdf` | 复步长求导及其与自动微分的关系 | 解析 Jacobian 的复步长精度核验及其避免差分相消误差的依据 |
| `07_Hindmarsh_et_al_2005_SUNDIALS.pdf` | 大规模刚性 ODE/DAE、线性多步法与 Newton–Krylov 框架 | 刚性半离散系统、隐式迭代和稀疏线性代数的软件方法背景 |
| `08_Virtanen_et_al_2020_SciPy_1_0.pdf` | SciPy 科学计算库的算法与软件体系 | 本文使用 SciPy 数值积分和插值工具的软件引用 |
| `09_Kumar_et_al_2022_Drying_Modeling_Review.pdf` | 果蔬干燥数学模型、热质传递与计算方法综述 | 干燥建模的一般研究背景、模型分类及热湿耦合依据 |
...
6. Martins 等人的资料用于支撑复步长检验。复步长法没有实数有限差分中的相减运算，因此能在很小扰动量下避免相消误差；它在本文中是 Jacobian 的独立核验方法，不是时间积分方法。
7. Virtanen 等人的论文适合在“计算工具”处引用；BDF 的具体算法描述仍应优先引用 Shampine–Reichelt，而不是只引用 SciPy 总览论文。
8. Akter 等人的综述适合支撑研究背景和干燥模型分类；具体控制方程仍应引用传热传质理论或与本文结构更接近的应用论文。
...
- Martins, Sturdza & Alonso: <https://mdolab.engin.umich.edu/bibliography/Martins2003a>
- Hindmarsh et al.: <https://doi.org/10.1145/1089014.1089020>
- Virtanen et al.: <https://doi.org/10.1038/s41592-019-0686-2>
- Akter et al.: <https://doi.org/10.1155/2022/6195257>
