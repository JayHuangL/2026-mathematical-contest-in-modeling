...
def main():
    ...
    summary = {'model': 'Appendix 3 throughout; 1D radial; effective moisture Robin boundary; no latent heat',
               'input_sha256': hashlib.sha256((ROOT/'data'/'附件1.xlsx').read_bytes()).hexdigest(),
               ...
               'raw_environment_sha256': hashlib.sha256((ROOT/'data'/'附件1.xlsx').read_bytes()).hexdigest(),
