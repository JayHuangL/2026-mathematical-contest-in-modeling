...
本目录是 A 题第一问的独立提交目录。最终正文见 [p1.md](p1.md)；正文参考 `docs/25B优秀论文.pdf` 的论文骨架，按“摘要—问题重述—问题分析—假设与符号—模型建立与求解—模型检验—模型评价—结论”的顺序组织，但保留本题已有的物理模型和数值方法。总体论文 [../paper.md](../paper.md) 仅作为背景参考，本次整理没有修改它。原始题面与附件也没有被修改。
