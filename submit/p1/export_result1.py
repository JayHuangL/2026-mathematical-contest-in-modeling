...
Run this file from submit/p1 after solve_q1.py.  The template is kept in
data/result1_template.xlsx so the submission package is self-contained.
"""
...
TEMPLATE = HERE / "data" / "result1_template.xlsx"
PAYLOAD = HERE / "result1_data.json"
OUTPUT = HERE / "result1.xlsx"
