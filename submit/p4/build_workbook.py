...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build result4.xlsx from result4_data.json.")
    parser.add_argument("--root", type=Path, default=HERE.parent.parent / "questions" / "A题")
    parser.add_argument("--output", type=Path, default=HERE / "result4.xlsx")
    args = parser.parse_args()

    data = json.loads((HERE / "result4_data.json").read_text(encoding="utf-8"))
    template = args.root / "附件" / "附件3" / "result4.xlsx"
