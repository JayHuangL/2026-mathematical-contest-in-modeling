...
DEFAULT_ROOT=HERE.parent.parent/'questions'/'A题'
...
def load_q2(root):
    spec=importlib.util.spec_from_file_location('q2_model',root/'第二问/solve_q2.py')
...
def main():
    ...
    q3path=a.root/'第三问/validation.json'
    if q3path.exists():
